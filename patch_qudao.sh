...
download_azurlane () {
    ...
    #这个链接是当乐网
    url="https://res5.d.cn/6c5e06daf05ea2f5f7dd18b03a08302bfddc1a03b7ec32b6ece198ebfe6d8e0ed11b32ec6c4dcfab4b52778ad64d5ceb97885f8f6396ee437fa8c178e8694cd2e4a27a8875815131.apk"
    # 使用wget命令下载apk文件
    curl -o blhx.apk  $url
    fi
}
